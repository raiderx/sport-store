...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <h1> <a href="${pageContext.request.contextPath}"> Спортивные товары </a> / Ботинки </h1>
        ...
        <table>
            ...
            <tr>
                ...
                <td> <a href="${pageContext.request.contextPath}${requestScope['javax.servlet.forward.servlet_path']}?action=edit&id=<%=skiBoot.getId()%>"> Изменить </a> </td>
                <td> <a href="${pageContext.request.contextPath}${requestScope['javax.servlet.forward.servlet_path']}?action=remove&id=<%=skiBoot.getId()%>"> Удалить </a> </td>
            </tr>
            <% } %>
            <% if (skiBoots.isEmpty()) { %>
